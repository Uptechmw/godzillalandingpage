...
import { Coins, CheckCircle2, Zap, Trophy, Crown, Loader2 } from "lucide-react";
...
const PACKAGES = [
    {
        ...
        features: ['Access to GPT-4o', 'Standard speed', 'Email support']
    },
    {
        id: 'pro',
        name: 'Professional',
        ...
        features: ['All AI models included', 'Unlimited history', 'Priority support', 'Beta feature access']
    },
    {
        id: 'whale',
        name: 'Whale tier',
        ...
        features: ['All Pro features', 'Dedicated API key', 'Custom token limits', '24/7 VIP Support']
    }
];
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {PACKAGES.map((pkg) => (
                        ...
                        >
                            ...
                            <div className={`w-14 h-14 ${pkg.bg} ${pkg.color} rounded-2xl flex items-center justify-center mb-6 border ${pkg.border}`}>
                                <pkg.icon size={28} />
                            </div>
